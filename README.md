...
<img src="https://github.com/raulneto90/gostack-desafio05/blob/master/images/tests.png" alt="Testes do desafio" />
...
```bash
$ git clone https://github.com/raulneto90/gostack-desafio05
$ cd gostack-desafio05
